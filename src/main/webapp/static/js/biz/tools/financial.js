...
App.controller("financialController", ['$scope','$http',  function ($scope,$http) {
    ...
    $scope.queryList = function(){
        var url = globalConfig.basePath+"/otProductAudit/list";
    ...
    $scope.saveEdit = function(){
        ...
        var url = globalConfig.basePath+"/otProductAudit/edit";
    ...
    $scope.validateRecord = function(x){
        ...
        if($scope.effectRecord.isEnable=='0'){
            url = globalConfig.basePath+"/otProductAudit/valid";
        } else {
            url = globalConfig.basePath+"/otProductAudit/invalid";
        }
    ...
    $scope.confirm = function(){       
        var url = globalConfig.basePath+"/otProductAudit/confirm";
